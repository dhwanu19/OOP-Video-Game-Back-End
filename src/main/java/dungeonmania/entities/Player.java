...
public class Player extends Entity implements Battleable, OnOverlap {
    ...
    public Sceptre getUnusedSceptre() {
        return inventory.getUnusedSceptre();
    }
    ...
    public void onOverlap(GameMap map, Entity entity) {
        if (entity instanceof Enemy && !isInvincible()) {
    ...
    public void bribeUsingTreasure() {
        Treasure item = inventory.getFirstBribableTreasure();
        if (item != null)
            inventory.remove(item);
    }
    ...
    public void triggerNext(int currentTick) {
        ...
        state = inEffective.getPlayerState(this);
    ...
    public int numKeys() {
        return inventory.getEntities(Key.class).size();
    }
